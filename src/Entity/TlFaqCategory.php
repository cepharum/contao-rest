 ...
 * @ORM\Entity(repositoryClass="App\Repository\TlFaqCategoryRepository")
 */
class TlFaqCategory
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="notify", type="string", length=16, nullable=false)
     */
    private $notify = '';
     ...
     * @var string
     *
     * @ORM\Column(name="sortOrder", type="string", length=12, nullable=false)
     */
    private $sortorder = '';
